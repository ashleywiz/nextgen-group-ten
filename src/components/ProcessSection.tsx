...
const ProcessSection = () => {
  ...
  return <section id="process" className="py-20 md:py-28 bg-secondary/30">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {processSteps.map((step, index) => <div key={index} className="bg-card rounded-2xl p-6 eco-shadow-md border border-border hover:border-primary/30 transition-all">
        ...
        <div className="bg-primary/10 rounded-2xl p-8 text-center max-w-3xl mx-auto">
          <p className="text-foreground text-lg font-medium">We welcome individuals and organisations in Goa to join this effort to promote environmental sustainability. Every item you recycle with us, stays out of the landfill.</p>
        </div>
      </div>
    </section>;
};
